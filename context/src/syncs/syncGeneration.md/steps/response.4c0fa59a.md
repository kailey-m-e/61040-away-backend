...
content_id: 4c0fa59a9bd35c8216d7b5d526925b7b6248cd9c9bfcaaf60ec1dee097692b7f
---
...
\#prompt: Using the background document on implementing synchronizations and following the structure of the document of (commented out) sample syncs, create the following syncs ("CreatePost", "EditPostTitle", "EditPostPlace", "EditPostDates", "EditPostDescription", "DeletePost", "GetPosts") using the actions in postingConcept.ts.
