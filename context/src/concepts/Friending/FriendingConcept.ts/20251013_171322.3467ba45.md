---
timestamp: 'Mon Oct 13 2025 17:13:22 GMT-0400 (Eastern Daylight Time)'
content_id: 3467ba4569c55aa6c93b4f3d3f475ddc859c6c369951f2848b19ff9e0b12229a
---
...
export default class FriendingConcept {
    ...
    async requestFriend({user, friend}: {user: User, friend: User}
        ...
        const alreadyFriend = await this.friends.findOne({_id: user, friends: friend});
        const userAlreadyRequested = await this.friends.findOne({_id: user, outgoingRequests: friend});
        const friendAlreadyRequested = await this.friends.findOne({_id: friend, outgoingRequests: user});
