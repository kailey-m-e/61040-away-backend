---
timestamp: 'Sat Oct 18 2025 16:09:20 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251018_160920.0e8cdd63.md]]'
content_id: 684aa047f059f518459a1c841790697999f100e9f5545f0431ea1d15a9511dc6
---
...
Deno.test("Test Case 7 - Concurrency Scenarios", async () => {
  ...
  try {
    ...
    assertEquals(
      endAB_succeeded !== endBA_succeeded,
      true,
      "Exactly one of two mutual end friendship requests should succeed atomically.",
    );
    ...
    if (endAB_succeeded) {
      assertEquals(
        endBA.error,
        `No friendship exists between user with ID ${userB} and friend with ID ${userA}.`,
        "B->A end should fail because A->B already ended.",
      );
    } else {
      assertEquals(
        endAB.error,
        `No friendship exists between user with ID ${userA} and friend with ID ${userB}.`,
        "A->B end should fail because B->A already ended.",
      );
    }
