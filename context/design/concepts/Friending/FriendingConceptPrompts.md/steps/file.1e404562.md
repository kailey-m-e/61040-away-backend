---
timestamp: 'Sat Oct 18 2025 15:03:09 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251018_150309.9a1c0f6d.md]]'
content_id: 1e404562bec9c8e4d47560cae339fa1a97e9f723c7ad6365d8e8c69375fcf0ea
---
...
export default class FriendingConcept {
  ...
  async endFriendship(
    ...
    return await this._runInTransaction(async (session) => {
      ...
      // check if match was found
      if (!userFriendshipPulled) { // If no doc matched, the friendship did not exist from user's side
        throw new Error(
          `No friendship exists between user with ID ${user} and friend with ID ${friend}.`,
        );
      }
